...
while (True):
    ...
    if convert[0] in ['b', 'B']:
        num_in = int (input ("Type the integer you want to convert to the base 2."))
        print ('The integer ', num_in, ' in binary : {0:b}'.format (num_in))
    elif convert[0] in ['h', 'H']:
        num_in = int (input ("Type the integer you want to convert to the base 16."))
        print ('The integer ', num_in, ' in hexadecimal : {0:x}'.format (num_in))
    elif convert[0] in ['d', 'D']:
        num_in = int (input ("Type the integer you want to convert to the base 10."))
